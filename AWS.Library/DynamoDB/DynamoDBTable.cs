...
namespace AWS.DynamoDB
{
    ...
    public class DynamoDBTable
    {
        ...
        public static DynamoDBTable CreateTable(String accessKey, String secretAccessKey, String tableName, String hashKeyAttributeName, Types.Enum hashKeyAttributeType, Int64 readCapacityUnits, Int64 writeCapacityUnits)
        {
            ...
            KeySchemaElement keySchemaElement = new KeySchemaElement() { AttributeName = hashKeyAttributeName, AttributeType = Types.String[hashKeyAttributeType] };
            KeySchema keySchema = new KeySchema() { HashKeyElement = keySchemaElement };
            ...
            CreateTableResult createTableResult = createTableResponse.CreateTableResult;
        ...
        public void UpdateItem(DynamoDBItem item, UpdateAction action)
        {
            ...
            updateItemRequest.Key = new Key() { HashKeyElement = item.HashKey.ToAttributeValue() };
            // Set Attribute Value
        ...
        public void DeleteItem(DynamoDBAttribute itemPrimaryKey)
        {
            if (itemPrimaryKey.IsHashKey)
            {
                ...
                deleteItemRequest.Key = new Key() { HashKeyElement = itemPrimaryKey.ToAttributeValue() };
        ...
        public DynamoDBItem GetItem(DynamoDBAttribute itemPrimaryKey, List<String> returnAttributes)
        {
            ...
            getItemRequest.Key = new Key() { HashKeyElement = itemPrimaryKey.ToAttributeValue() };
